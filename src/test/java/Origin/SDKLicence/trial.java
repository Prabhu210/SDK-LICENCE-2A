...
public class trial extends Baseclass {
 ...
 // Example usage in LicenceManagement class
    private void scheduleEmailReminder(String expiryDateText, LocalDate currentDate, LocalDate reminderDate30Days, LocalDate reminderDate29Days, LocalDate reminderDate15Days, LocalDate reminderDate28Days) {
        try {
            ...
            // Sending email using EmailSender class
    ...
    private void sendEmailWithoutLogging(String recipientEmail, String subject, String body) {
        // Implement your email sending logic here without logging sensitive information
        try {
            // Replace this with your actual email sending implementation
            System.out.println("Sending email to: " + recipientEmail);
            System.out.println("Subject: " + subject);
            System.out.println("Body: " + body);
            // Example using JavaMail API or any other email library
            // Your actual email sending code goes here
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
